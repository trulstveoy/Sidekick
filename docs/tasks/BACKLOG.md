...
| BL-0008 | Candidate | Explore project-independent content model | Conversation 2026-05-13; `docs/architecture/prosjektuavhengig-innholdsmodell.md` | Sidekick currently treats the project folder as the primary organizing unit, but some content, especially transcriptions, may belong to multiple projects. A project-only folder structure may force duplicate files or unclear ownership. This needs careful product and information-architecture work because Sidekick may need both a clean folder structure and project-based views through tags or metadata. | Explore whether Sidekick should support a hybrid model with reusable content, project tags, and project-specific files. Define alternatives, storage implications, UI implications, migration risks, and how this would affect context packages, summaries, search, and future project workflows before creating implementation tasks. |
